<template>
    <div>
        <el-breadcrumb separator="/">
            ...
            <el-breadcrumb-item>Color 色彩</el-breadcrumb-item>
        </el-breadcrumb>
        <h3>Color 色彩</h3>
        <span class="desc">
        ...
        <h3>主色</h3>
        <span class="desc">Element 主要品牌颜色是鲜艳、友好的蓝色。</span>
        <div class="el-row">
            <div class="el-col el-col-8 pl6 pr6">
        ...
        <h3>辅助色</h3>
        <span class="desc">除了主色外的场景色，需要在不同的场景中使用（例如危险色表示危险的操作）。</span>
        <div class="el-row">
            <div class="el-col el-col-6 pl6 pr6">
        ...
        <h3>中性色</h3>
        <span class="desc">中性色用于文本、背景和边框颜色。通过运用不同的中性色，来表现层次结构。</span>
        <div class="el-row">
            <div class="el-col el-col-6 pl6 pr6">
