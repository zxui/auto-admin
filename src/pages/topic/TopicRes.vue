<template>
    <div class="c-con">
        <div style="margin-bottom: 1%">
            ...
            <el-button type="primary" icon="el-icon-search" @click="serachAll" style="margin-left: 10px;"> 全 部
            </el-button>
        ...
        <el-table :data="tableData" border style="width: 100%">
            ...
            <el-table-column
                    ...
                    width="190">
                <template scope="scope">
                    <span style="margin-left: 10px">{{ scope.row.topicTypeName }}</span>
                </template>
            </el-table-column>
            <el-table-column
                    label="描述"
        ...
        <el-dialog title="题库资源" width="800px" :visible.sync="dialogFormVisible">
            <el-form :model="form">
